...
<section class="bg-gray-100 min-h-screen w-full pl-6 sm:pl-[88px] pr-6 overflow-hidden font-inter">
    <div class="h-4 flex items-center gap-1 my-2">
        ...
        <p class="text-gray-400">/ Create quest</p>
    </div>
    <h1 class="font-bold text-2xl leading-7 my-6">Create quest</h1>
    @if (session('success'))
    ...
    <div class="w-full bg-white rounded-lg shadow my-4 p-6">
        ...
        <form action="{{ route('quest.create') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pt-4 pb-2 w-full max-w-md">
                ...
                <input type="number" id="completion" name="max_completion"
                    class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
            </div>
            <div class="pt-4 pb-2 w-full max-w-md">
            ...
            <div class="pt-4 pb-2 w-full max-w-md">
    <label for="exp" class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">Quest
        Exp</label><span class="text-red-500">*</span>
    <input type="number" id="exp" name="exp"
        class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
</div>

            <div class="pt-4 pb-2 w-full max-w-md">
                <label for="content" class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">Quest
                    Content</label><span class="text-red-500">*</span>
                <textarea id="content" name="content" rows="4" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900"></textarea>
            </div>
