...
<section class="bg-gray-100 min-h-screen w-full pl-6 sm:pl-[88px] pr-6 overflow-hidden font-inter">
    ...
    <div class="w-full bg-white rounded-lg shadow my-4 p-6">
        ...
        <form action="{{ route('event.create') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid lg:grid-cols-3">
                <div>
                    <div class="pt-4 pb-2 w-full max-w-md">
                        <label for="title" class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">Event
                            title</label><span class="text-red-500">*</span>
                        <input type="text" id="title" name="title" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                    </div>

                    <div class="w-full max-w-md py-2">
                        <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1" for="start">Start</label><span class="text-red-500">*</span>
                        <input type="datetime-local" name="start" id="start" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                    </div>
                    <div class="w-full max-w-md py-2">
                        <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1" for="end">End</label><span class="text-red-500">*</span>
                        <input type="datetime-local" name="end" id="end" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                    </div>

                </div>

                <div class="w-full max-w-md py-2">
                    <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">Event Image</label><span class="text-red-500">*</span>
            ...
            <div>
                <h3 class="text-base leading-6 uppercase text-gray-400 mt-4">Event sub contents</h3>
                <div class="grid lg:grid-cols-3">
                    <div>
                        <div class="pt-4 pb-2 w-full max-w-md">
                            <label for="sub_title" class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">
                                Sub title</label><span class="text-red-500">*</span>
                            <input type="text" id="sub_title" name="sub_title" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                        </div>
                        <div class="pt-4 pb-2 w-full max-w-md">
                            <label for="sub_content" class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">
                                Sub content</label><span class="text-red-500">*</span>
                            <textarea cols="3" type="text" id="sub_content" name="sub_content" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                        </textarea>
                        </div>
                    </div>
                    <div class="w-full max-w-md py-2">
                        <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1">Event Image</label><span class="text-red-500">*</span>
                        <div class="bg-gray-100 p-8 text-center rounded-lg border-dashed border-2 border-gray-300 hover:border-blue-500 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-md" id="dropzone2">
                            <label for="sub_image" class="cursor-pointer flex flex-col items-center space-y-2">
                                <svg class="w-16 h-16 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                                <span class="text-gray-600">Drag and drop your files here</span>
                            ...
                            <input type="file" id="sub_image" name="banner" class="hidden" multiple>
                        </div>
                        <div class="mt-6 text-center" id="fileList"></div>
                    </div>
                </div>
            ...
            <div>
            <h3 class="text-base leading-6 uppercase text-gray-400">Event Items</h3>
           <div>
             <form action="{{ route('item.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="w-full max-w-md py-2">
                    <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1"
                        for="qty">Qty</label><span class="text-red-500">*</span>
                    <input type="number" name="qty" id="qty"
                        class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none text-gray-900">
                </div>
                <div>
                    <label class="inline-block text-sm leading-5 font-medium text-gray-900 mb-1" for="reduce">Can
                        reduce</label>
                    <div class="flex items-center justify-start">
                        <input type="checkbox" value="1" name="can_reduce" id="reduce"
            ...
            <button type="submit" class="py-2 px-4 mt-2 rounded-lg bg-pink-400 hover:bg-pink-500 text-white duration-300">Send</button>
